    ...
    <>
        <div className="w-full bg-alternate-custom font-quicksand" id="sobre-mi">
            <div className="container mx-auto px-4 lg:px-8">
              <div className="grid grid-cols-2 gap-4 pt-12 pb-12">
                <div>
                  <BadgedSection title="SOBRE MI"/>
                  <p className="mt-8 text-2xl text-white font-bold mb-4">Ingeniero de Software y Senior Full Stack Developer</p>
                  <p className="text-white text-md mb-4">Soy Cristian Alejandro Hortua Saenz. Con más de 5 años de experiencia creando soluciones de software, transformo necesidades de negocio en productos digitales eficientes, escalables y fáciles de mantener.</p>
                  <p className="text-white text-md mb-4">He trabajado en todo el ciclo de vida del software: desde el levantamiento de requerimientos y diseño de soluciones, hasta desarrollo, pruebas, despliegue y puesta en producción.</p>
                  <p className="text-white text-md mb-4">Mi enfoque combina pensamiento analítico, buenas prácticas de desarrollo y aprendizaje constante para construir software que no solo funcione, sino que aporte valor real</p>
                </div>
                <div>
